...
int main()
{
    ...
    cout << "\nVacation Ends: ";
    stDate to = Read_Date(to);
    cout << "\nVaction From: " << Day_Name(Find_Day_Order_In_Week(from));
    printf(", %d/%d/%d\n", from.Day, from.Month, from.Year);
    cout << "Vaction To: " << Day_Name(Find_Day_Order_In_Week(to));
    printf(", %d/%d/%d\n", to.Day, to.Month, to.Year);
    cout << "\n\nActucal Vacation Days is: " << Vacation_Days(from, to);
    return 0;
}